...
#ifndef NeighborTable_hpp
#define NeighborTable_hpp
...
private:
    ...
    unsigned short cur_neighbor_index[MAX_NEIGHBOR_COUNTS];//邻域中点的索引
    float cur_neighbor_distance[MAX_NEIGHBOR_COUNTS];//邻域中点的距离
public:
    NeighborTable();
    ~NeighborTable();
